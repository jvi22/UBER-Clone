...
const UserLogin = () => {
  ...
  return (
    ...
    <button className='bg-[#111] text-white mb-2 rounded px-4 py-2 w-full text-lg placeholder:text-base'>
    Login</button>
  </form>
   ...
   <Link to='/captain-login'
     className='bg-[#10b461] flex items-center justify-center text-white font-medium mb-5 rounded px-4 py-2 w-full text-lg placeholder:text-base'
